...
_PERSISTED = ("ai_score", "risk_grade", "pd", "dscr", "apr", "affordability",
              "ecl_12m", "ifrs9_stage", "shap_codes", "model_version")
...
def assess(app: dict) -> dict:
    ...
    result = {
        "pd": s["pd"], "risk_grade": s["risk_grade"], "ai_score": s["ai_score"],
        "dscr": dscr, "apr": apr, "affordability": aff,
        "lgd": lgd, "ead": ead, "ecl_12m": ecl, "ifrs9_stage": stage,
        "shap_codes": s["shap_codes"], "recommendation": rec,
