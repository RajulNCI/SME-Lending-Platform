...
both locally and against managed Postgres (e.g. Neon / Supabase / AWS RDS):
  ...
  * strips libpq-only query params (`sslmode`, `channel_binding`) that asyncpg cannot parse,
...
def _prepare_url_and_args(raw_url: str) -> tuple[str, dict, bool]:
...
def make_engine(echo: bool | None = None):
